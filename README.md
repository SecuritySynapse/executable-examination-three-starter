...
- [ ] Complete the self assessment of achievement of the course learning objectives
...
- You **may not** modify any part of the provided source code that the instructions say not to modify

**TODO: IMPORTANT**: All students in this course are obligated to adhere to the
...
**TODO: Please note that your `git push` access to the GitHub repository containing
...
TODO: Please fill out the [CMPSC 403 Fall 2024: Learning Objectives Self
Assessment](https://forms.gle/L6ENtAYYSMs8hn2N7) to complete the self assessment
